...
import com.novice.huaweipushdemo.OnDialogClickListener
import com.novice.huaweipushdemo.R

class TopicDialog @SuppressLint("InflateParams") constructor(context: Context, isAdd: Boolean) :
